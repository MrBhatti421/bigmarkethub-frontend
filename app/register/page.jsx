...
export default function RegisterPage() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true);
    try {
      const { data } = await publicApi.post('/user/register', form);
  ...
  return (
    <main className="flex items-center justify-center min-h-screen px-4 bg-black">
      ...
      >
        <h1 className="text-2xl font-bold text-center text-primary">نیا اکاؤنٹ بنائیں</h1>
        ...
        >
          {loading ? 'انتظار کریں...' : 'رجسٹر کریں'}
        </button>
